...
class KerasPMHA(Layer):
    ...
    def _masked_softmax(self, attention_scores, attention_mask=None, bias_mask = None):
        ...
        if bias_mask is not None:
            bias_mask = tf.transpose(bias_mask, perm=[0,3,1,2])
            return self._softmax(attention_scores+bias_mask, attention_mask)
            
        else:
            return self._softmax(attention_scores, attention_mask)

    def _compute_attention(
        self, query, key, value, attention_mask=None, bias_mask=None, training=None
    ):
        ...
        attention_scores = self._masked_softmax(
            attention_scores, attention_mask, bias_mask
        )
    ...
    def call(
        ...
        attention_output, attention_scores = self._compute_attention(
            query, key, value, attention_mask, bias_mask, training
        )
